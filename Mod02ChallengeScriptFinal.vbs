...
Sub stockAnalysis():
    ...
    Dim percentChange As Double     ' variable thtat holds the percent change for each stock in a sheet
    ...
    For Each ws In Worksheets
        ...
        ' get the value of the last row in the curret sheet
        ...
        For row = 2 To rowCount
            ...
            If ws.Cells(row + 1, 1).Value <> ws.Cells(row, 1).Value Then
                ...
                ' add to the total stock value one last time
                ...
                Else
                    ...
                    If ws.Cells(startValue, 3).Value = 0 Then
                        ' if the first open is 0, search for the first non-zero stock open value by movig to the next rows
                    ...
                    'print the results in the summar table section (Columns I - L)
                    ...
                    avergaeChange = 0       'resets the average change for the next ticker
            ...
            Else
                ...
                total = total + ws.Cells(row, 7).Value ' Gets the value fromt he 7th column (G)
        ...
        ' clean up (f needed) to avoid having extra data be placed in the summary section
        ' find the last tow of data in the summary table by finding the last ticker in the summary section
